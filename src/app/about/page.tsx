...
export default function AboutPage() {
  ...
  const jsonLd = {
    ...
    "mainEntity": {
      "@type": "Organization",
      "name": "MedGenz",
      "description": "Leading manufacturer and installer of Modular Operation Theatres and Medical Gas Pipeline Systems.",
      "foundingDate": "2012",
      "areaServed": "India",
      "knowsAbout": ["Modular OT", "MGPS", "Hospital Infrastructure"]
    }
  };
