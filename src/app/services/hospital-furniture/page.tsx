          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
            <Link href="#" className="group bg-white rounded-lg md:rounded-2xl border border-gray-200 shadow-sm hover:shadow-md hover:border-brand-300 transition-all overflow-hidden flex flex-col text-center md:text-left">
              ...
              <div className="p-2 md:p-5 flex flex-col flex-grow items-center md:items-start">
                <h4 className="font-bold text-gray-900 group-hover:text-brand-700 text-[10px] md:text-base leading-tight mb-1">Ward Layout Drawing</h4>
            ...
            <Link href="#" className="group bg-white rounded-lg md:rounded-2xl border border-gray-200 shadow-sm hover:shadow-md hover:border-brand-300 transition-all overflow-hidden flex flex-col text-center md:text-left">
              ...
              <div className="p-2 md:p-5 flex flex-col flex-grow items-center md:items-start">
                <h4 className="font-bold text-gray-900 group-hover:text-brand-700 text-[10px] md:text-base leading-tight mb-1">Product Catalog</h4>
                <p className="hidden md:block text-xs text-gray-500 mb-4 flex-grow font-light">PDF Document • Bed Specifications</p>
                <div className="text-[9px] md:text-xs font-bold text-brand-600 flex items-center gap-1 md:gap-2 mt-auto">Open Document <ExternalLink className="w-3 h-3 md:w-4 md:h-4" /></div>
              </div>
            </Link>
            <Link href="#" className="group bg-white rounded-lg md:rounded-2xl border border-gray-200 shadow-sm hover:shadow-md hover:border-brand-300 transition-all overflow-hidden flex flex-col text-center md:text-left">
              ...
              <div className="p-2 md:p-5 flex flex-col flex-grow items-center md:items-start">
                <h4 className="font-bold text-gray-900 group-hover:text-brand-700 text-[10px] md:text-base leading-tight mb-1">Actuator Wiring Guide</h4>
                <p className="hidden md:block text-xs text-gray-500 mb-4 flex-grow font-light">Technical Datasheet • Electric Beds</p>
                <div className="text-[9px] md:text-xs font-bold text-brand-600 flex items-center gap-1 md:gap-2 mt-auto">Open Document <ExternalLink className="w-3 h-3 md:w-4 md:h-4" /></div>
              </div>
            </Link>
          </div>
