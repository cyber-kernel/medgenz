      ...
      <section className="py-6 md:py-10 px-6 md:px-10 bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-6 md:mb-10">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mb-2 md:mb-3 text-gray-900 uppercase tracking-tighter">Anatomy of <span className="text-brand-600">Reliability</span></h2>
